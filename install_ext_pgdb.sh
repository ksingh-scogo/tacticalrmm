...
SCRIPT_VERSION="87"
SCRIPT_URL="https://raw.githubusercontent.com/ksingh-scogo/tacticalrmm/refs/heads/ksingh-v1.0.0/install_ext_pgdb.sh"
...
git clone https://github.com/ksingh-scogo/tacticalrmm.git /rmm/
cd /rmm
git checkout ksingh-v1.0.0
